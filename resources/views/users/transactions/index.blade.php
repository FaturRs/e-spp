    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form class="validation" novalidate method="POST" action="{{ url('transactions/add') }}">
          ...
          <div class="form-row">
            <div class="col-md-6 mb-3">
              <label class="form-control-label" for="other_payment">Pembayaran lainnya</label>
              <select class="form-control" name="other_payment" id="other_payment" >
                <option selected disabled>== PILIH ==</option>
                <option>Ujian Tengah Semester</option>
                <option>Ujian Akhir Semester</option>
                <option>Keperluan Praktikum</option>
                <option>Iuran Komite</option>
                <option>-</option>
              </select>
              <div class="invalid-feedback">
                Pilih Jenis Pembayaran Terlebih Dahulu.
            ...
            <div class="col-md-6 mb-3">
              <label class="form-control-label" for="more_payments">Biaya Tambahan</label>
              <input type="text" class="form-control" id="more_payments" name="more_payments" >
            </div>
          </div>
          <div class="form-row" id="form-spp">
            ...
            <div class="col-md-6">
              <label class="form-control-label" for="detail_spp">Total Biaya *</label>
...
<script type="text/javascript">
  $('#for_month').on('change', function () {
    ...
    var biaya_tambahan = parseFloat($('#more_payments').val()) || 0;

    var i = ($(this).val() - last_month) * amount_spp + biaya_tambahan;
    $('#total_spp').val(i);
